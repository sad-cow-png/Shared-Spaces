...
urlpatterns = [
    ...
    path('space_update_times/<date_time_id>', views.update_space_date_time, name='update_date_time'),
    path('search_results/', views.index, name='search_results'),
    ...
    path('save_space/<space_id>', views.save_space, name='save_space'),
    path('saved_spaces/', views.saved_spaces, name='saved_spaces'),
]
