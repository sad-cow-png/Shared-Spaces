    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('space_address2', models.CharField(default='', max_length=1024)),
                ...
                ('space_owner', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='SpaceDateTime',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('space_date', models.CharField(default='EMPTY', max_length=100)),
                ('space_start_time', models.CharField(default='EMPTY', max_length=100)),
                ('space_end_time', models.CharField(default='EMPTY', max_length=100)),
